...
function handleComputerArrowCollision() {
  ...
  for(var i = 0; 1 < playerArrows.length; i++){
    ...
    var playerArcher = Matter.SAT.collides(playerArrows[i].body, computerBase.body);
  
    var computerArcher = Matter.SAT.collides(playerArrows[i].body, computerBase.body);

    var playerBase = Matter.SAT.collides(playerArrows[i].body, computerBase.body);
  
  
    if(playerArcher.collided || computerArcher.collided || playerBase.collided){
